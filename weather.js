$(function() {
  ...
  function getOutfit() {
    var htmlstr = '';
    htmlstr.setAttribute("width", "304");
    htmlstr.setAttribute("height", "228");
    if(temp == 59) {
      htmlstr += '<img src = "images/1stoutfit.png"';
    } else {
      return "hi";
    }
     return htmlstr;
  ...
  document.getElementById("weatherNow").innerHTML = getOutfit();
});
...
imgArray[1].src = "images/1outfitt.png";
...
imgArray[18].src = "images/guyoutfit22.png";

imgArray[19] = new Image();
imgArray[19].src = "images/guyoutfit33.png";

imgArray[20] = new Image();
imgArray[20].src = "images/guyoutfit44.png";

imgArray[21] = new Image();
imgArray[21].src = "images/guyoutfit55.png";

imgArray[22] = new Image();
imgArray[22].src = "images/guyoutfit66.png";

imgArray[23] = new Image();
imgArray[23].src = "images/guyoutfitt.png";
